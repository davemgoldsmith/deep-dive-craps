 ...
 * @author
 */
public class GuiGame implements StateMachine.Playable, StateMachine.Continuable, StateMachine.Display {
	...
	private void createAndShowGui() {
		...
		losses.setForeground(Color.RED);
		point.setForeground(Color.BLUE);
		roll.setForeground(Color.ORANGE);
		//wins.setVisible(false);
		//losses.setVisible(false);
		point.setVisible(false);
		roll.setVisible(false);
		textPanel.setMinimumSize(new Dimension (50, 50));
		textPanel.add(wins);
